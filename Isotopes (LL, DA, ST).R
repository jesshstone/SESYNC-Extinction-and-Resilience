...
ggplot(SantoTomasCM, aes(x = SantoTomasCM$`age[ka]`, y = SantoTomasCM$d18O))+ geom_line(aes(color = 'Santo Tomas'))+
...
ggplot(SantoTomasCM, aes(x = SantoTomasCM$`age[ka]`, y = SantoTomasCM$d13C))+ geom_line(aes(color = 'Santo Tomas'))+
